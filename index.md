...
<div class="tools-container">
  ...
  <div class="video-container braincell" onclick="location.href='{% link braincell.md %}'">
    <div class="video-text">
      ...
      signalling, on the scale from nanometers to hundreds of microns</p>
    </div>
    <br>
  ...
  <div class="video-container stochastic" onclick="location.href='{{ '/stochsyn.html' | relative_url }}'">
    <div class="video-text">
      ...
      glutamate&ndash;transporter interactions around the synaptic cleft</p>
    </div>
    <br>
    <img class="video-fallback2" src="assets/BrainCellSpine.png" alt="STOCHASTIC SYNAPSE simulation preview">
